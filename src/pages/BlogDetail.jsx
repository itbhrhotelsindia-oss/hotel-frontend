...
export default function BlogDetail() {
  const blog = {
    ...
    //   <p>
    //     Las hojas "Letraset", que aparecieron en los años 60, impulsaron aún más su popularidad,
    //     permitiendo a los diseñadores incluirlo fácilmente en composiciones visuales. Hoy en día,
    //     sigue siendo una parte esencial del proceso creativo.
    //   </p>"
  };
  ...
  return (
    <div className="blog-detail-container">
      ...
      <div className="blog-meta">
        ...
        <span className="blog-date">Publish {blog.date}</span>
      </div>
