    ...
    <div style={styles.page}>
      ...
      {step === 1 && (
        <div style={styles.card}>
          ...
          <label style={styles.label}>Hotel ID <span style={styles.hint}>(optional — auto-generated if blank)</span></label>
          <input style={styles.input} placeholder="e.g. HOTEL-SHRAVASTI-001" value={hotelId} onChange={e => setHotelId(e.target.value)} />
